...
針對這兩個問題，如果你對 Linux 的歷史背景跟開發過程沒那麼熟悉，那我會推薦大家先去看「Rebel Code」(中譯: Linux傳奇)。為什麼這樣說呢？ 因為我自己讀 Just for Fun 時，很多時候因為不瞭解當時 Linux 開發事件的時空背景，所以無法體會 Linus 針對該事件所發表的看法。第二個是 Linus 本人實在很謙虛，往往輕描淡寫的帶過自己的事蹟。

我讀完 Rebel Code 之後又重讀此書，才終於有抓到一些感覺。舉個例子來說，像是 Linus 在書裡暢談他對 Linux 社群呈多頭馬車時的處理法，要了解他說的話，就得先知道 Linux 發展的過程中曾經出現過兩次分裂危機，一次 是 TCP/IP ，一次是 vger 事件。看完 Rebel code 後我才搞懂整個來龍去脈，事實上本書也只有 Linus 自己片面的說法，不夠全面。
